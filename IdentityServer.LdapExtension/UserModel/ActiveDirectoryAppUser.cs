    ...
    public class ActiveDirectoryAppUser : IAppUser
    {
        ...
        private void FillClaims(LdapEntry user)
        {
            ...
            this.Claims = new List<Claim>
                {
                    GetClaimFromLdapAttributes(user, "distinguishedName", ActiveDirectoryLdapAttributes.DistinguishedName),
                    ...
                    GetClaimFromLdapAttributes(user, "title", ActiveDirectoryLdapAttributes.Title),
